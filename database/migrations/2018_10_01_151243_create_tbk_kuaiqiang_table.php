...
class CreateTbkCouponsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbk_kuaiqiang', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('itemid', 11)->nullable();  //宝贝ID
            ...
            $table->integer('sales', 11)->nullable();  //	宝贝月销量
            $table->integer('today_sale', 11)->nullable();  //	当天销量
            $table->string('pic_url', 190)->nullable();  //	宝贝主图原始图像
            $table->integer('cat', 11)->nullable();  //商品类目
            ...
            $table->tinyInteger('type', 190)->nullable();  //	快抢开抢状态：1快抢即将开始；2快抢商品已抢光；3快抢商品正在快抢中
