...
class Taobao implements TBKInterface
{
    ...
    public function getDetail(array $array = [])
    {
        ...
        //重组字段
        if (isset($data->coupon->coupon_info)){
        ...
        $arr['coupon_total_count']  = isset($data->coupon->coupon_total_count) ? $data->coupon->coupon_total_count : null;//优惠卷总数
...
//        $arr['images']              = '';//商品详情图
        ...
        $arr['coupon_url'][]        = $data->coupon->coupon_click_url;//领劵地址
        return $arr;
    }
