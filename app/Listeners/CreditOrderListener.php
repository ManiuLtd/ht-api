...
class CreditOrderListener
{
    ...
    public function handle(CreditOrder $event)
    {
        ...
        if ($setting->credit_order) {
            ...
            if ($user) {
                creditAdd($user, $credit_order->order_commission1_credit1, 'credit1', '直推余额增加', 18); //余额
                creditAdd($user, $credit_order->order_commission1_credit2, 'credit2', '直推积分增加', 17); //积分
            ...
            if ($user && $user['inviter_id'] != null) {
                ...
                creditAdd($user_inviter, $credit_order->order_commission2_credit1, 'credit1', '上级余额增加', 18); //余额
                creditAdd($user_inviter, $credit_order->order_commission2_credit2, 'credit2', '上级积分增加', 17); //积分
            ...
            if ($user && $user['group_id'] != null) {
                ...
                creditAdd($user_group_id, $credit_order->order_group1_credit1, 'credit1', '组长余额增加', 18); //余额
                creditAdd($user_group_id, $credit_order->order_group1_credit2, 'credit2', '组长积分增加', 17); //积分
            ...
            if ($user && $user['oldgroup_id'] != null) {
                ...
                creditAdd($user_oldgroup_id, $credit_order->order_group2_credit1, 'credit1', '原组长余额增加', 18); //余额
                creditAdd($user_oldgroup_id, $credit_order->order_group2_credit2, 'credit2', '原组长积分增加', 17); //积分
